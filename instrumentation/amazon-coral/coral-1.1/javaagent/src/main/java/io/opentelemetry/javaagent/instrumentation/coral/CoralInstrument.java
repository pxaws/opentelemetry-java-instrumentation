...
public final class CoralInstrument implements ServiceInstrument {
  private static final Constant<Context> OPENTELEMETRY_CONTEXT = new Constant<>(Context.class, "OPENTELEMETRY_CONTEXT");
  private static final Constant<Scope> OPENTELEMETRY_SCOPE = new Constant<>(Scope.class, "OPENTELEMETRY_SCOPE");
  ...
  public void beforeActivity(Job job) {
    ...
    System.out.println("======== DEBUG: CoralInstrument.beforeActivity() operationName = " + operationName);
