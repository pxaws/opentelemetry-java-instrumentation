...
public class CoralClientInstrumentationModule extends InstrumentationModule
  ...
  public String getModuleGroup() {
    return "coral-client-1.1";
  }

  @Override
  public boolean isHelperClass(String className) {
    return className.startsWith("com.amazon.opentelemetry.javaagent.instrumentation.coralclient.");
  }
  ...
  public void registerHelperResources(HelperResourceBuilder helperResourceBuilder) {
    System.out.println(
        "======== DEBUG: register for com.amazon.coral.core.instrumentation.ClientInstrumentProvider");
    helperResourceBuilder.register(
        "META-INF/services/com.amazon.coral.core.instrumentation.ClientInstrumentProvider",
        "META-INF/services/com.amazon.coral.core.instrumentation.ClientInstrumentProvider");
  }
  ...
  public void injectClasses(ClassInjector injector) {
    injector
        .proxyBuilder(
            "com.amazon.opentelemetry.javaagent.instrumentation.coralclient.CoralClientInstrumentProvider")
  ...
  public class ResourceInjectingTypeInstrumentation implements TypeInstrumentation {
    ...
    public ElementMatcher<TypeDescription> typeMatcher() {
      ...
      // ResourceInjectingTypeInstrumentation.typeMatcher()");
